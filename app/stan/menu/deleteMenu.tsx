...
const DeleteMenu = ({ selectedMenu }: { selectedMenu: Menu }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const url = `${BASE_API_URL}/hapus_menu/${menu.id}`;
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="sticky top-0 bg-white px-5 pt-5 pb-3 shadow">
            <div className="flex items-center">
              <div>
                <h2 className="text-2xl font-bold text-red-600">Hapus Menu</h2>
          ...
          <div className="p-5">
            <p className="text-sm">
              ...
              <strong className="text-red-600">{menu.nama_makanan}</strong>?
            </p>
          </div>
          ...
          <div className="p-5 flex justify-end gap-2 border-t">
            ...
            <ButtonDanger type="submit">Ya, Hapus</ButtonDanger>
          </div>
        </form>
      </Modal>
    </div>
