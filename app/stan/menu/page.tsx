...
import { get, post } from "@/lib/api-birdge";
    ...
    <div className="m-5 bg-white rounded-lg p-5 border-t-4 border-blue-500 shadow-md text-blue-900">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="w-full max-w-md">
          <Search url="/detail_menu" search={search} onSearch={setSearch} />
        </div>
        <AddMenu />
      </div>
      ...
      {/* ===== LOADING STATE ===== */}
      {isLoading && (
        <div className="text-center py-8 text-blue-600">Loading menu...</div>
      )}
